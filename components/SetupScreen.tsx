  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-black text-foreground relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 left-0 w-full h-96 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-zinc-800/20 via-black to-black" />
      </div>
      ...
      <div className="relative w-full max-w-[600px] p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="relative h-24 border border-zinc-800 rounded-lg border-dashed hover:border-zinc-600 transition-colors bg-black flex flex-col items-center justify-center overflow-hidden group cursor-pointer">
                ...
                {previewUrl ? (
                  ...
                  <div className="text-center p-2">
                    <span className="block text-zinc-500 text-xs font-medium group-hover:text-zinc-300 transition-colors">
                      Upload Source
                    </span>
                  </div>
                )}
          ...
          {error && (
            <div className="rounded-md border border-red-900/40 bg-red-950/20 px-4 py-3 text-sm text-red-300">
              {error}
            </div>
          )}
          ...
          <div className="pt-6">
            <Button
              ...
              disabled={isStarting}
              className="w-full h-12 text-base shadow-none hover:shadow-lg transition-shadow"
            >
              Launch Session
            </Button>
          </div>
