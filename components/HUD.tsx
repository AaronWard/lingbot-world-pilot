  ...
  return (
    <div className="absolute inset-0 pointer-events-none p-6 flex flex-col justify-between z-20 font-sans">
      ...
      <div className="flex justify-between items-start">
        ...
        {/* Latency Graph */}
        <div className="w-40 h-12 bg-black/50 backdrop-blur-sm border border-zinc-800/50 rounded-md overflow-hidden relative">
          <div className="absolute top-1 right-2 text-[9px] font-medium text-zinc-500 z-10 tracking-wider">LATENCY</div>
